                    ...
                    <td className="size-px whitespace-nowrap">
                      <a className="block relative z-10" href="#">
                        <div className="px-6 py-2 flex gap-x-1">
                          ...
                          <svg
                            className="shrink-0 size-3 text-transparent"
                            xmlns="http://www.w3.org/2000/svg"
                            width={16}
                            height={16}
                            fill="currentColor"
                  ...
                  <tr className="bg-white hover:bg-gray-50 dark:bg-neutral-900 dark:hover:bg-neutral-800">
                    ...
                    <td className="size-px whitespace-nowrap">
                      <a className="block relative z-10" href="#">
                        <div className="px-6 py-2 flex -space-x-2">
                          <div className="hs-tooltip inline-flex">
                            <span className="hs-tooltip-toggle inline-flex items-center justify-center size-6 rounded-full bg-gray-600 ring-2 ring-white dark:bg-neutral-400 dark:ring-neutral-900">
                          ...
                          <div className="hs-tooltip inline-flex">
                            <span className="hs-tooltip-toggle inline-flex justify-center items-center size-6 bg-gray-100 text-xs rounded-full ring-2 ring-white dark:bg-neutral-500 dark:text-white dark:ring-neutral-900">
                      ...
                      <a className="block relative z-10" href="#">
                        <div className="px-6 py-2">
                          <p className="text-sm text-gray-500 dark:text-neutral-500">
                            ...
                            development. They are quality assurance experts who
                            put applications
                          </p>
                        </div>
                      </a>
